...
public class TinyDB {
    ...
    public ArrayList<SubjectDetails> getSubjectDetailsListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SubjectDetails> objects =  new ArrayList<SubjectDetails>();

        for(String jObjString : objStrings){
            SubjectDetails value  = (SubjectDetails) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListSubjectDetails(String key, ArrayList<SubjectDetails> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
